...
När 1'a Endpointen anropas med t.ex. "/api/v1/geo?city=Stockholm" så skickar server detta till klient:
{ "city":"Stockholm","country":"SE","lat":59.3293,"lon":18.0686 }

När 2'a Endpointen anropas med t.ex. "/api/v1/weather?lat=59.3293&lon=18.0686" så skickar server detta till klient:
{ "tempC":7.0,"description":"0","updatedAt":"2025-11-02T09:00:00Z" }

CodeﾠDescription kan innehålla dessa variabler:
0ﾠClear sky
